            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <p className="text-xl text-foreground-secondary max-w-2xl leading-relaxed">
                  Crafting premium web applications and digital products with
                  cutting-edge technology, stunning design, and performance that
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass p-8 group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-foreground-secondary leading-relaxed">
                Scalable, accessible UI libraries with design tokens and
            ...
            <div className="glass p-8 group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-foreground-secondary leading-relaxed">
                Full-stack applications with Next.js, React, and seamless API
                integrations optimized for performance.
              </p>
            </div>
            ...
            <div className="glass p-8 group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-foreground-secondary leading-relaxed">
                Immersive marketing sites with motion design and compelling
            ...
            <div className="glass p-8 group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-foreground-secondary leading-relaxed">
                Lightning-fast sites with perfect Core Web Vitals, SEO
      ...
      <section id="projects" className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground-secondary max-w-3xl mx-auto">
              A curated selection of recent work showcasing innovation, design
                ...
                <div className="p-8">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        <svg
                          className="w-4 h-4 text-blue-400 group-hover/btn:scale-110 transition-transform"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      >
                        <svg
                          className="w-4 h-4 text-purple-400 group-hover/btn:scale-110 transition-transform"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
          ...
          <div className="glass p-12 sm:p-16 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-foreground-secondary mb-12 leading-relaxed">
                ...
                deployment, I deliver premium digital experiences that exceed
                expectations.
              </p>
