            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base sm:text-lg text-foreground/70">
                  Fluxera is a boutique freelance studio building elevated
                  products and brand sites with modern tech, motion, and
                  meticulous design. I partner with teams to ship work that
                  feels premium and performs.
                </p>
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  <a
                    href="#projects"
                    className="inline-flex items-center gap-2 rounded-lg px-5 py-3 text-sm font-medium border border-foreground/15 hover:bg-foreground/5 transition"
                  >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="glass rounded-xl p-5">
              ...
              <p className="mt-2 text-sm text-foreground/70">
                Scalable, accessible UI libraries with tokens and theming.
              </p>
            </div>
            <div className="glass rounded-xl p-5">
              <h3 className="text-lg font-semibold">Web Apps</h3>
              <p className="mt-2 text-sm text-foreground/70">
                Next.js, React, and API integrations built for speed.
              </p>
            </div>
            <div className="glass rounded-xl p-5">
              <h3 className="text-lg font-semibold">Brand Sites</h3>
              <p className="mt-2 text-sm text-foreground/70">
                Aesthetic, animated marketing sites with strong storytelling.
              </p>
            </div>
            <div className="glass rounded-xl p-5">
              <h3 className="text-lg font-semibold">Performance</h3>
              <p className="mt-2 text-sm text-foreground/70">
                Core Web Vitals, SEO, and a11y best practices by default.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-foreground/60 mt-1">
                A snapshot of recent builds and experiments.
              </p>
            </div>
            <a
              href="#socials"
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-12 gap-5">
            {projects.map((p) => (
              <article
                key={p.id}
                className="relative md:col-span-6 rounded-2xl overflow-hidden glass group"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex gap-3 text-sm">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-lg px-3 py-2 border border-foreground/15 hover:bg-foreground/5 transition bg-white text-black hover:text-white hover:bg-foreground transition-all duration-300 ease-in-out"
                    >
                      Live
                    </a>
                    <a
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              <div>
                ...
                <p className="mt-1 text-sm text-foreground/70">
                  Open to select collaborations and premium freelance
                  engagements.
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-3 text-sm">
                <a
                  className="rounded-lg border border-foreground/15 px-3 py-2 hover:bg-foreground/5 transition"
